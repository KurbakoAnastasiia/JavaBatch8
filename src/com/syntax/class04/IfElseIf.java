	...
	public static void main(String[] args) {
		...
		*/
		...
		if (num1 > num2) {
			...
			System.out.println(num1 + " is egual than " + num2);
		...
		*/
		...
		if (day == 1) {
			...
			System.out.println("Today is Wensday and we have Manual class again");
		} else if (day == 4) {
			...
			System.out.println("Today is Saturday, I miss Jva classes");
		} else if (day == 7) {
